...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-135299888-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-135299888-1');
</script>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-2206756960478885",
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-2206756960478885"
     data-ad-slot="4536071577"
     data-ad-format="auto"
...
<!--        <a class="nav-link navbar-expand-lg" href="index.html" style="color:white; font-size: 20px;">Home</span></a>-->
<!--      </li>-->
<!--      <li class="nav-item active">-->
<!--        <a class="nav-link" href="#" style="color:white; font-size: 20px;">Mcq</a>-->
<!--      </li>-->
<!--       <li class="nav-item active">-->
<!--        <a class="nav-link" href="./ppt/ppt_branch.php" style="color:white; font-size: 20px;">PPt</a>-->
<!--      </li>-->
...
<center><p>MORAL STORY</p></center>
<p>Letting go is probably one story lesson that can teach both the child and the parent a valuable lesson. Children are hands down very impressionable and sensitive, and there are times when you as a parent might not want to accept that a line needs to be drawn, they need to become independent.
